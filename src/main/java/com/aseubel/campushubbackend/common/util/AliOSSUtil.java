package com.aseubel.campushubbackend.common.util;
...
public class AliOSSUtil {
    ...
    public String upload(Image image) throws com.aliyuncs.exceptions.ClientException {
        try {
            return upload(image.getImage().getInputStream(), image.imageObjectName());
        } catch (IOException e) {
            log.error("Caught an IOException, which means an error occurred while reading the file.");
        }
        return null;
