...
import com.aseubel.campushubbackend.common.annotation.constraint.RequirePermission;
import com.aseubel.campushubbackend.common.exception.AuthenticationException;
import com.aseubel.campushubbackend.common.exception.AuthorizationException;
...
import static com.aseubel.campushubbackend.common.Constant.HEADER_AUTHORIZATION;
import static com.aseubel.campushubbackend.common.Constant.TOKEN_PREFIX;
...
public class AuthAspect {
    ...
    private boolean hasPermission(User user, RequirePermission requirePermission) {
        return user.getRole() == User.RoleEnum.ADMIN;
    }
